...
public partial class txtbxRoundedControl : UserControl {
    ...
    public static readonly DependencyProperty txtbxCornerRadiusProperty =
          DependencyProperty.Register(nameof(txtbxCornerRadius), typeof(CornerRadius), typeof(txtbxRoundedControl),
    ...
    public static readonly DependencyProperty txtbxMarginProperty =
          DependencyProperty.Register(nameof(txtbxMargin), typeof(Thickness), typeof(txtbxRoundedControl),
    ...
    public static readonly DependencyProperty txtbxBackgroundProperty =
          DependencyProperty.Register(nameof(txtbxBackground), typeof(Brush), typeof(txtbxRoundedControl),
    ...
    public static readonly DependencyProperty txtbxForegroundProperty =
          DependencyProperty.Register(nameof(txtbxForeground), typeof(Brush), typeof(txtbxRoundedControl),
    ...
    public static readonly DependencyProperty txtbxBorderBrushProperty =
          DependencyProperty.Register(nameof(txtbxBorderBrush), typeof(Brush), typeof(txtbxRoundedControl),
             new PropertyMetadata(Brushes.Black));
    ...
    public static readonly DependencyProperty txtbxBorderThicknessProperty =
        DependencyProperty.Register(nameof(txtbxBorderThickness), typeof(Thickness), typeof(txtbxRoundedControl),
    ...
    public static readonly DependencyProperty txtbxWidthProperty =
          DependencyProperty.Register(nameof(txtbxWidth), typeof(int), typeof(txtbxRoundedControl),
    ...
    public static readonly DependencyProperty txtbxHeightProperty =
          DependencyProperty.Register(nameof(txtbxHeight), typeof(int), typeof(txtbxRoundedControl),
    ...
    public static readonly DependencyProperty txtbxFontSizeProperty =
          DependencyProperty.Register(nameof(txtbxFontSize), typeof(int), typeof(txtbxRoundedControl),
    ...
    public static readonly DependencyProperty txtbxFontWeightProperty =
          DependencyProperty.Register(nameof(txtbxFontWeight), typeof(string), typeof(txtbxRoundedControl),
    ...
    public static readonly DependencyProperty txtbxPaddingProperty =
          DependencyProperty.Register(nameof(txtbxPadding), typeof(Thickness), typeof(txtbxRoundedControl),
    ...
    public static readonly DependencyProperty txtbxHorizContentAlignProperty =
          DependencyProperty.Register(nameof(txtbxHorizContentAlign), typeof(string), typeof(txtbxRoundedControl),
    ...
    public static readonly DependencyProperty txtbxVertContentAlignProperty =
          DependencyProperty.Register(nameof(txtbxVertContentAlign), typeof(string), typeof(txtbxRoundedControl),
    ...
    public static readonly DependencyProperty txtbxHorizAlignProperty =
        DependencyProperty.Register(nameof(txtbxHorizAlign), typeof(string), typeof(txtbxRoundedControl), 
            new PropertyMetadata("Center"));
    ...
    public static readonly DependencyProperty txtbxVerticAlignProperty =
        DependencyProperty.Register(nameof(txtbxVerticAlign), typeof(string), typeof(txtbxRoundedControl), 
            new PropertyMetadata("Center"));
    ...
    public static readonly DependencyProperty txtbxTextProperty =
          DependencyProperty.Register(nameof(txtbxText), typeof(string), typeof(txtbxRoundedControl),
    ...
    public static readonly DependencyProperty txtbxCommandProperty =
          DependencyProperty.Register(nameof(txtbxCommand), typeof(ICommand), typeof(txtbxRoundedControl),
             new PropertyMetadata(null));



    public txtbxRoundedControl() {
        InitializeComponent();
    }
}
