...
public partial class SelectionControls : UserControl
{
    ...
    public static readonly DependencyProperty MaintBackgroundProperty =
        DependencyProperty.Register(nameof(MaintBackground), typeof(Brush), typeof(SelectionControls),
    ...
    public static readonly DependencyProperty MaintCornerRadiusProperty =
          DependencyProperty.Register(nameof(MaintCornerRadius), typeof(CornerRadius), typeof(SelectionControls),
    ...
    public static readonly DependencyProperty btnBrdrBackgroundProperty =
        DependencyProperty.Register(nameof(btnBrdrBackground), typeof(Brush), typeof(SelectionControls),
            new PropertyMetadata(new BrushConverter().ConvertFrom("#B6C7DC")));
    ...
    public static readonly DependencyProperty btnBrdrMarginProperty =
          DependencyProperty.Register(nameof(btnBrdrMargin), typeof(Thickness), typeof(SelectionControls),
    ...
    public static readonly DependencyProperty btnBrdrHeightProperty =
        DependencyProperty.Register(nameof(btnBrdrHeight), typeof(string), typeof(SelectionControls),
    ...
    public static readonly DependencyProperty btnBrdrWidthProperty =
        DependencyProperty.Register(nameof(btnBrdrWidth), typeof(string), typeof(SelectionControls),
            new PropertyMetadata("auto"));
    ...
    public static readonly DependencyProperty btnBrdrBrushProperty =
        DependencyProperty.Register(nameof(btnBrdrBrush), typeof(Brush), typeof(SelectionControls),
    ...
    public static readonly DependencyProperty btnBrdrThicknessProperty =
          DependencyProperty.Register(nameof(btnBrdrThickness), typeof(Thickness), typeof(SelectionControls),
    ...
    public static readonly DependencyProperty btn2ndBrdrBrushProperty =
        DependencyProperty.Register(nameof(btn2ndBrdrBrush), typeof(Brush), typeof(SelectionControls),
    ...
    public static readonly DependencyProperty btn2ndBrdrThicknessProperty =
        DependencyProperty.Register(nameof(btn2ndBrdrThickness), typeof(Thickness), typeof(SelectionControls),
    ...
    public static readonly DependencyProperty btnBrdrCornerRadiusProperty =
          DependencyProperty.Register(nameof(btnBrdrCornerRadius), typeof(CornerRadius), typeof(SelectionControls),
             new PropertyMetadata(new CornerRadius(20, 20, 20, 20)));
    ...
    public static readonly DependencyProperty btnHeightProperty =
        DependencyProperty.Register(nameof(btnHeight), typeof(string), typeof(SelectionControls),
            new PropertyMetadata("Auto"));
    ...
    public static readonly DependencyProperty btnWidthProperty =
        DependencyProperty.Register(nameof(btnWidth), typeof(string), typeof(SelectionControls),
            new PropertyMetadata("Auto"));
    ...
    public static readonly DependencyProperty btnClickCommandProperty =
          DependencyProperty.Register(nameof(btnClickCommand), typeof(ICommand), typeof(SelectionControls),
    ...
    public static readonly DependencyProperty btnCmdParameterProperty =
        DependencyProperty.Register(nameof(btnCmdParameter), typeof(object), typeof(SelectionControls),
            new PropertyMetadata(null));
    ...
    public static readonly DependencyProperty btnForegroundProperty =
        DependencyProperty.Register(nameof(btnForeground), typeof(Brush), typeof(SelectionControls),
            new PropertyMetadata(new BrushConverter().ConvertFrom("#000")));
    ...
    public static readonly DependencyProperty btnContentFontSizeProperty =
        DependencyProperty.Register(nameof(btnContentFontSize), typeof(string), typeof(SelectionControls),
    ...
    public static readonly DependencyProperty btnContentTextProperty =
        DependencyProperty.Register(nameof(btnContentText), typeof(string), typeof(SelectionControls),
    ...
    public static readonly DependencyProperty TextVertAlignProperty =
        DependencyProperty.Register(nameof(TextVertAlign), typeof(string), typeof(SelectionControls),
    ...
    public static readonly DependencyProperty btnHorizAlignProperty =
        DependencyProperty.Register(nameof(btnHorizAlign), typeof(HorizontalAlignment), typeof(SelectionControls),
    ...
    public static readonly DependencyProperty btnVertAlignProperty =
        DependencyProperty.Register(nameof(btnVertAlign), typeof(VerticalAlignment), typeof(SelectionControls),
    ...
    public static readonly DependencyProperty ImagePathProperty =
        DependencyProperty.Register(nameof(ImagePath), typeof(string), typeof(SelectionControls), new PropertyMetadata(null));
    ...
    public static readonly DependencyProperty ImageSourceProperty =
        DependencyProperty.Register(nameof(ImageSource), typeof(ImageSource), typeof(SelectionControls), new PropertyMetadata(null));
    ...
    public static readonly DependencyProperty ImageWidthProperty =
        DependencyProperty.Register(nameof(ImageWidth), typeof(int), typeof(SelectionControls), new PropertyMetadata(30));
    ...
    public static readonly DependencyProperty ImageHeightProperty =
        DependencyProperty.Register(nameof(ImageHeight), typeof(int), typeof(SelectionControls), new PropertyMetadata(30));
    ...
    public static readonly DependencyProperty ImageMarginProperty =
        DependencyProperty.Register(nameof(ImageMargin), typeof(Thickness), typeof(SelectionControls),
            new PropertyMetadata(new Thickness(0, 0, 0, 0)));
